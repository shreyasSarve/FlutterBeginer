...
class ModifyDetails extends StatefulWidget {
  ...
  ModifyDetails({required this.name, required this.password});
  @override
  State<StatefulWidget> createState() {
    return ModifyDetailsState(name, password);
  }
}

class ModifyDetailsState extends State<ModifyDetails> {
  MaterialColor nameColor = Colors.red;
  final _nameController = TextEditingController();
  final _passwordController = TextEditingController();

  ModifyDetailsState(String name, String password) {
